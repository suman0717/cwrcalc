    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(125.0, 69.0),
            child:
                // Adobe XD layer: 'logo-colored' (shape)
                Container(
              width: 126.0,
              height: 120.0,
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage('images/ercolored.png'),
                  fit: BoxFit.fill,
                ),
              ),
            ),
          ...
          Transform.translate(
            offset: Offset(-919.01, 198.99),
            child: Stack(
              children: <Widget>[
                Transform.translate(
                  offset: Offset(1085.68, 526.0),
                  child:
                      // Adobe XD layer: 'Group_1' (group)
                      Stack(
                    children: <Widget>[
                      SvgPicture.string(
                        _svg_b84708,
                ...
                Transform.translate(
                  offset: Offset(1101.8, 534.85),
                  child:
                      // Adobe XD layer: 'Group_2' (group)
                      Stack(
                    children: <Widget>[
                      Transform.translate(
                        offset: Offset(0.0, 8.53),
                        child:
                            // Adobe XD layer: 'Group_3' (group)
                            Stack(
                          children: <Widget>[
                            SvgPicture.string(
                              _svg_yn5ud,
